Ext.define('Admin.view.stockDetail.StockDetailViewController', {
	...
	openEditWindow:function(grid, rowIndex, colIndex){
		...
		//Ext.get('imageId').dom.src="'resources/images/"+record.get('stockDetailImg')+"'"; 
		win.show();
	...
	searchComboboxSelectChuang:function(combo,record,index){
		...
		}else if(searchField==='stockDetailPrice'){
			...
			if(repoid1==repoid2){
		        ...
		        if(nullFlag==1){
					...
					if(Flagplus==1){
						...
						if(bothFlag==0){
							if((Ext.getCmp('com1')&&Ext.getCmp('text1'))==null){
	...
	submitSearchForm:function(btn){
		...
		}else if(searchWindowField==='stockDetailName'){
			toSubmit[0]='stockDetailName';
			toSubmit[1]=searchTextValue2;
		}else if(searchWindowField==='stockDetailNum'){
